  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[#000000] text-white flex flex-col animate-in slide-in-from-bottom duration-300 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-4 pb-safe">
          ...
          <div className="bg-gradient-to-r from-blue-900/40 to-purple-900/40 border border-orange-500/20 rounded-2xl p-4 flex items-start gap-3">
              <div className="p-2 bg-orange-500/20 rounded-full text-orange-400 shrink-0">
          ...
          <div className="bg-[#1c1c1e] p-5 rounded-3xl">
              <div className="flex justify-between items-center mb-6">
                  ...
                  <div className="flex items-center gap-2 text-sm text-orange-500 font-bold cursor-pointer select-none">
                  ...
                  <div className="bg-[#2c2c2e] p-1 rounded-xl flex">
                      {(['Week', 'Month', 'Year'] as const).map(r => (
                          <button
                              key={r}
                              onClick={() => setRange(r)}
                              className={`px-6 py-1.5 rounded-lg text-xs font-bold transition-all ${range === r ? 'bg-gradient-to-br from-orange-500 to-amber-400 text-white' : 'text-slate-400 hover:text-white'}`}
                          >
                              {r}
                          </button>
                      ))}
