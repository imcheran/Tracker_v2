      ...
      <div className="p-4 space-y-8 pb-24">
          ...
          <div>
              <div className="flex justify-between items-center mb-4 px-2">
                  ...
                  <button onClick={() => setShowInvModal(true)} className="p-2 bg-slate-100 dark:bg-slate-800 rounded-full text-slate-500 hover:text-indigo-500 transition-colors">
                      <Plus size={16} />
                  </button>
              </div>
              ...
              <div className="space-y-3">
                  {investments.map(inv => (
                      <div key={inv.id} className="bg-white dark:bg-slate-900 p-4 rounded-[24px] border border-slate-100 dark:border-slate-800 flex items-center justify-between shadow-sm relative group cursor-pointer hover:shadow-md transition-all">
                          <div className="flex items-center gap-3">
                              <div className="w-12 h-12 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-500 rounded-[18px] flex items-center justify-center">
          ...
          <div>
              <div className="flex justify-between items-center mb-4 px-2">
                  ...
                  <button onClick={() => setShowSubModal(true)} className="p-2 bg-slate-100 dark:bg-slate-800 rounded-full text-slate-500 hover:text-indigo-500 transition-colors">
                      <Plus size={16} />
                  </button>
              </div>
                            ...
                            <div className="flex gap-3">
                                ...
                                {isSplit && (
                                    <div className="flex-1 relative animate-in fade-in slide-in-from-right duration-300">
                                        ...
                                        />
                                        <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] font-bold text-indigo-500 uppercase pointer-events-none bg-slate-50 dark:bg-slate-800 pl-1">My Share</span>
                                    </div>
                                )}
                            </div>
                            ...
                            {type === 'debit' && (
                                <div className="flex justify-end px-1">
                                    <button 
                                        ...
                                        className={`text-xs font-bold px-3 py-1.5 rounded-full flex items-center gap-1.5 transition-colors ${isSplit ? 'bg-indigo-100 text-indigo-500 dark:bg-indigo-900/30 dark:text-indigo-400' : 'text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800'}`}
                                    >
                                        <Split size={14} /> 
