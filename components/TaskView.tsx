...
const SwipeableWrapper: React.FC<{
  ...
  return (
    <div className="relative overflow-hidden rounded-[24px]">
      {/* Background Actions */}
      <div className={`absolute inset-0 flex items-center justify-between px-6 text-white transition-colors ${offset > 0 ? 'bg-orange-500' : 'bg-orange-500'}`}>
        ...
        >
            <div className="flex items-start justify-between gap-3">
                ...
                <button 
                    ...
                    className={`shrink-0 w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all shadow-sm ${task.isCompleted ? 'bg-slate-400 border-slate-400 text-white' : 'border-slate-300 hover:border-orange-500 bg-white dark:bg-transparent'}`}
                >
    ...
    return (
        <div 
            ...
            className={`
                ...
                ${isSelected ? 'ring-4 ring-orange-500 shadow-xl scale-95 z-10' : 'hover:-translate-y-1 hover:shadow-lg'}
